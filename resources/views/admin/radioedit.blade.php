    ...
    <style>
        ...
        <div class="grid grid-cols-12 gap-4 py-9 max-w-7xl mx-auto">
            <div class="col-span-12 md:col-span-6">
                <form action="{{ url('admin/updateradio') }}" method="post" class="bg-white rounded p-4 max-w-4xl mx-auto ">
                    <h2 class="text-2xl uppercase text-teal-500 mb-4">update radio channel</h2>
                    ...
                    <input type="text" name="title" value="{{old('title') ? old('title') : $channel->title }}" id="title"  class="w-full mb-4 rounded">
                    ...
                    <input type="url" name="link" value="{{old('link')? old('link') : $channel->link}}" id="link"  class="w-full mb-4 rounded">
                    ...
                    <textarea name="description" id="description" cols="30" rows="5" class="w-full mb-4 rounded">{{ old('description') ? old('description') : $channel->description }}</textarea>
            ...
            <div class="col-span-12 md:col-span-6">
                <form action="{{ url('admin/updateradioimage') }}" method="post" class="bg-white rounded p-4 max-w-4xl mx-auto " enctype="multipart/form-data">
                    <h2 class="text-2xl uppercase text-teal-500 mb-4">update radio image</h2>
                    ...
                    <div class="max-w-sm mx-auto">
                        <div id="preview-cont" onclick="selectFile()" class="bg-gray-100 rounded overflow-hidden hover:bg-gray-400 transition-all duration-150">
                            <img src="{{ asset($channel->image) }}" alt="" id="preview" class="aspect-square">
                        </div>
